...
def main():
    ...
    task = clearml.Task.init(project_name=args.project_name, task_type=clearml.TaskTypes.testing,
                             task_name=task_name, output_uri='s3://mentee-vision/mmdetection/clearml/')
    ...
    dist_script = os.path.join(tools_dir, 'dist_test.sh')
